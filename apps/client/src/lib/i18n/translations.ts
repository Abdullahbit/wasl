...
export const translations = {
  en: {
    ...
    plan: {
      pageTitle: 'Your Plan | WASL',
      title: 'Your personalized plan',
      subtitle: 'Based on your profile, here are your next steps in Türkiye.',
      loading: 'Preparing your plan…',
      emptyTitle: 'No personalized recommendations yet',
      emptyDescription: 'Complete your onboarding to get tailored next steps, or explore communities directly.',
      emptyAction: 'Explore communities',
      errorTitle: 'We couldn’t load your plan',
      errorDescription: 'Your profile is still here. Please try again.',
      retry: 'Retry',
      whyThis: 'Why this?',
      whyThisClose: 'Close',
      warning: 'Showing deterministic matches',
      deterministicTitle: 'Recommended for you',
      whyReasons: {
        university: 'University match',
        interest: 'Interest match',
        goal: 'Goal match',
        language: 'Language match',
        arrival: 'Arrival stage match',
        newcomer: 'Newcomer-friendly',
      },
    },
    communities: {
      pageTitle: 'Communities | WASL',
      title: 'Discover communities',
      subtitle: 'Find verified communities relevant to your situation and interests.',
      loading: 'Loading communities…',
      empty: 'No communities match these filters.',
      emptyDescription: 'Try clearing filters or exploring with different criteria.',
      errorTitle: 'We couldn’t load communities',
      ...
      filters: {
        ...
        noResults: 'No communities match these filters.',
      },
      card: {
        category: 'Category',
        languages: 'Languages',
      ...
      details: {
        ...
        recommendationContext: 'Why this is relevant for you',
        languages: 'Languages',
        category: 'Category',
        interests: 'Interests',
        location: 'Location',
        ...
        verified: 'Verified by WASL',
        notVerified: 'Not yet verified',
        newcomerFriendly: 'Newcomer-friendly',
        notNewcomerFriendly: 'Not specifically newcomer-friendly',
        activities: 'Activities',
        join: 'Join',
        visit: 'Visit',
        noAction: 'No join link available',
        noDescription: 'No description available.',
        notFound: 'Community not found.',
        notFoundDescription: 'The community you are looking for does not exist or was removed.',
      },
    },
  },
  ar: {
    ...
    plan: {
      pageTitle: 'خارطتك | وصل',
      title: 'خارطتك الشخصية',
      subtitle: 'بناءً على ملفك، إليك خطواتك التالية في تركيا.',
      loading: 'نُجهّز خارطتك…',
      emptyTitle: 'لا توجد توصيات مخصصة بعد',
      emptyDescription: 'أكمل التأهيل للحصول على خطوات مخصصة أو استكشف المجتمعات مباشرة.',
      emptyAction: 'استكشاف المجتمعات',
      errorTitle: 'لم نتمكن من تحميل خارطتك',
      errorDescription: 'ملفك لا يزال هنا. حاول مرة أخرى.',
      retry: 'إعادة المحاولة',
      whyThis: 'لماذا هذا؟',
      whyThisClose: 'إغلاق',
      warning: 'عرض النتائج الحتمية',
      deterministicTitle: 'موصى به لك',
      whyReasons: {
        university: 'مطابقة الجامعة',
        interest: 'مطابقة الاهتمام',
        goal: 'مطابقة الهدف',
        language: 'مطابقة اللغة',
        arrival: 'مطابقة مرحلة الوصول',
        newcomer: 'مناسب للقادمين الجدد',
      },
    },
    communities: {
      pageTitle: 'المجتمعات | وصل',
      title: 'اكتشف المجتمعات',
      subtitle: 'اعثر على مجتمعات موثوقة ذات صلة بوضعك واهتماماتك.',
      loading: 'جارٍ تحميل المجتمعات…',
      empty: 'لا توجد مجتمعات تطابق هذه الفلاتر.',
      emptyDescription: 'جرّب مسح الفلاتر أو الاستكشاف بمعايير مختلفة.',
      errorTitle: 'لم نتمكن من تحميل المجتمعات',
      ...
      filters: {
        ...
        noResults: 'لا توجد مجتمعات تطابق هذه الفلاتر.',
      },
      card: {
        category: 'الفئة',
        languages: 'اللغات',
        university: 'الجامعات',
        newcomerFriendly: 'مناسب للقادمين الجدد',
        verified: 'موثّق',
      ...
      details: {
        ...
        backToPlan: 'العودة إلى الخارطة',
        recommendationContext: 'لماذا هذا مناسب لك',
        languages: 'اللغات',
        category: 'الفئة',
        ...
        verified: 'موثّق بواسطة وصل',
        notVerified: 'لم يتم التحقق بعد',
        newcomerFriendly: 'مناسب للقادمين الجدد',
        notNewcomerFriendly: 'ليس مخصصاً للقادمين الجدد تحديداً',
        activities: 'الأنشطة',
        join: 'انضم',
        visit: 'زيارة',
        noAction: 'لا يوجد رابط انضمام متاح',
        noDescription: 'لا يوجد وصف متاح.',
        notFound: 'المجتمع غير موجود.',
        notFoundDescription: 'المجتمع الذي تبحث عنه غير موجود أو تمت إزالته.',
      },
    },
  },
} as const;
