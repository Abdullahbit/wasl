...
export function CardHeader({ className, ...properties }: HTMLAttributes<HTMLDivElement>) {
  return <div data-slot="card-header" className={cn('grid gap-1.5 p-7', className)} {...properties} />;
}

export function CardTitle({ className, ...properties }: HTMLAttributes<HTMLHeadingElement>) {
  return <h2 data-slot="card-title" className={cn('text-xl font-semibold tracking-tight', className)} {...properties} />;
}

export function CardContent({ className, ...properties }: HTMLAttributes<HTMLDivElement>) {
  return <div data-slot="card-content" className={cn('p-7 pt-0', className)} {...properties} />;
}
